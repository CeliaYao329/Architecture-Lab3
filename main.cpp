...
CacheConfig config_cache(int size, int associativity, int block_size, int write_through, int write_allocate);
MemoryStorage m;
Cache l1;
Cache l2;
...
int main(int argc, char *argv[]) {
    ...
    CacheConfig l1_config = config_cache(32 * 1024, 8, 64, 0, 1);
    l1.SetConfig(l1_config);
    CacheConfig l2_config = config_cache(256 * 1024, 8, 64, 0, 1);
