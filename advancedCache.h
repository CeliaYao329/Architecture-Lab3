...
class Cache: public Storage {
 ...
 private:
  // Bypassing
  int BypassDecision(unsigned int set_index,unsigned int cur_tag);
  // Partitioning
  ...
  void IncreUsedCnt(const int set_id, Block & block);
  void ResetUsedCnt(const int set_id, Block & block);
  // Prefetching
